...
# Product name
project = 'Charmed Aether SD-Core'
...
# don't know yet)
ogp_site_url = "https://canonical-charmed-aether-sd-core.readthedocs-hosted.com/"
...
html_context = {
    ...
    'product_page': 'github.com/canonical/charmed-aether-sd-core',
    ...
    'github_url': 'https://github.com/canonical/charmed-aether-sd-core',
